...
export class SearchService {
  ...
  async getSearchCollection(
    ...
    return await TMDBFetchHandle<SearchCollectionObject>(url, this.options);
  }
  ...
  async getSearchMovie(
    ...
    return await TMDBFetchHandle<SearchMovieObject>(url, this.options);
  }
  ...
  async getSearchActor(
    ...
    return await TMDBFetchHandle<SearchActorObject>(url, this.options);
  }
  ...
  async getSearchCompany(
    ...
    return await TMDBFetchHandle<SearchCompanyObject>(url, this.options);
  }
  ...
  async getSearchKeyword(
    ...
    return await TMDBFetchHandle<SearchKeywordObject>(url, this.options);
  }
}
